...
main_menu::main_menu(sf::RenderWindow& window)
    ...
    level_button.texture.loadFromFile("../team-triangle-eduapp/assets/play_button.png");
    ...
    level_button_def.position.Set(0.f, 0.f);
    ...
    quit_button.texture.loadFromFile("../team-triangle-eduapp/assets/play_button.png");
    ...
    auto width = _window.getSize();
    _items[0].sprite.setPosition(width.x/2-305, 700);
    _items[1].sprite.setPosition(width.x/2-305, 400);
    _items[2].sprite.setPosition(width.x/2-305, 100);
}
